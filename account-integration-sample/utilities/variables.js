...
export const basePath = process.env.OF_API_URL || 'https://api.dev.openfabric.co';
export const of_auth_url = process.env.OF_AUTH_URL || 'https://auth.dev.openfabric.co/oauth2/token'
...
export const of_issuer_url = process.env.OF_ISSUER_URL || 'https://issuer.dev.openfabric.co'