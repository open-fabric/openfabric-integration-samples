...
export const account_client_id = process.env.ACCOUNT_CLIENT_ID;
export const account_client_secrect = process.env.ACCOUNT_CLIENT_SECRET
...
export const of_gateway_redirect_url = process.env.OF_GATEWAY_REDIRECT_URL || 'https://gateway.dev.openfabric.co/pat/redirect'