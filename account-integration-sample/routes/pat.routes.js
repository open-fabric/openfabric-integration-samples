...
import {create, initiatePatCreation, consentCapturePage, approvePatLink, createPatPage, createPatSuccessPage} from '../controllers/pat.js'

const router = express.Router();

router.route('/api/pat').post(create);
router.route('/api/pat/init').post(initiatePatCreation);
