...
const getTransactionOrder = (): any => {
  ...
  return {
    ...
    partner_redirect_success_url: `https://merchant-1.samples.dev.openfabric.co/orchestrated/payment-success?merchant_ref=${partnerRefId}`,
    partner_redirect_fail_url: `https://merchant-1.samples.dev.openfabric.co/orchestrated/payment-failed?merchant_ref=${partnerRefId}`,
    customer_info: {
